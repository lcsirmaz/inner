...
"lines starting with F or f followed by d+1 floating point numerals separated\n"
"by spaces. The facet has equation f[1]*x1+...+f[d]*xd + f[d+1]=0.\n"
"    F 13 7 7 1 0 -10\n"
"Facets known to be facets of the final solution are printed using F as the\n"
"initial letter.\n"
"\n"
"Other non-empty lines in the output can start with C for comment, and contain\n"
"information such as the name and size of the problem; whether it is a partial\n"
"list; the number of vertices and facets generated, etc. In a dump file the\n"
"N line specifies upper bounds on the subsequent vertex and facet lines, and\n"
